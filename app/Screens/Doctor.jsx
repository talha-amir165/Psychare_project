                    ...
                    <View style={{ backgroundColor: 'white', borderRadius: 30 }}>
                        <View style={{ marginHorizontal: 25 }}>
                            ...
                            <View style={{ flexDirection: 'row', marginVertical: 20 }}>
                                <TouchableOpacity style={{ backgroundColor: ' rgba(65, 140, 253, 0.05)', marginHorizontal: 5, padding: 20, borderRadius: 32 }} onPress={() => navigation.navigate('BookAppointment', { doc })}>
                                    <Text>
                                        Online Consulation
                                    </Text>
                                </TouchableOpacity>
